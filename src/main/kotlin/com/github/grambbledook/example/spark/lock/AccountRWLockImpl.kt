...
internal typealias LockType = (AccountRWLockImpl.RWLock) -> Lock

open class AccountRWLockImpl : AccountRWLock {
    ...
    override fun <T> lockRead(id: Long, executeCriticalSection: () -> T): T {
        try {
            acquire(id, READ)
